...
create_config() {
    ...
    echo "REDASH_MAIL_SERVER=email-smtp.us-west-2.amazonaws.com" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_USE_SSL=true" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_PORT=465" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_DEFAULT_SENDER=${REDASH_MAIL_DEFAULT_SENDER}" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_USERNAME=${REDASH_MAIL_USERNAME}" >> $REDASH_BASE_PATH/env
    echo "REDASH_MAIL_PASSWORD=${REDASH_MAIL_PASSWORD}" >> $REDASH_BASE_PATH/env
    echo "REDASH_HOST=${REDASH_HOST}" >> $REDASH_BASE_PATH/env
}
