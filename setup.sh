...
create_config() {
    ...
    sudo echo "PYTHONUNBUFFERED=0" >> $REDASH_BASE_PATH/env
    sudo echo "REDASH_LOG_LEVEL=INFO" >> $REDASH_BASE_PATH/env
    sudo echo "REDASH_REDIS_URL=redis://redis:6379/0" >> $REDASH_BASE_PATH/env
    sudo echo "POSTGRES_PASSWORD=$POSTGRES_PASSWORD" >> $REDASH_BASE_PATH/env
    sudo echo "REDASH_COOKIE_SECRET=$COOKIE_SECRET" >> $REDASH_BASE_PATH/env
    sudo echo "REDASH_SECRET_KEY=$SECRET_KEY" >> $REDASH_BASE_PATH/env
